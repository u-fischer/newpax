...
The style \pkg{newpax} is based on \texttt{pax.sty} but extends it in various way. It is an experimental package which requires the experimental pdfmanagement code.
