...
local function __writepax (ext,file)
  ...
  print("XXXXXXXXXXX",table.serialize(destnamestorefVAR))
  ...
  for i=1, pagecountVAR do
    ...
    if annots then
      for j = 0,#annots-1 do
        ...
        --  print("!!!",table.serialize(DICTIONARYTOTABLE(annotaction)))
          ...
          if annotaction then
            ...
            elseif annotactiontype =="GoTo" then
              ...
              print("?????????",desttype,destname,destdetail)
              destcountVAR=destcountVAR + 1
              WRITE ( outputKV_goto (destcountVAR) )
            ...
            if annotactiontype =="GoTo" then
              ...
              print("xxxxxxx",destname,type,annotactiongoto,hex)
